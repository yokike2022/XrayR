...
使用教程：[详细使用教程](https://crackair.gitbook.io/Huac233/)
## 免责声明
...
### 手动安装
[手动安装教程](https://crackair.gitbook.io/Huac233/xrayr-xia-zai-he-an-zhuang/install/manual)

## 配置文件及详细使用教程

[详细使用教程](https://crackair.gitbook.io/Huac233/)
...
[Mozilla Public License Version 2.0](https://github.com/Huac233/XrayR/blob/master/LICENSE)
